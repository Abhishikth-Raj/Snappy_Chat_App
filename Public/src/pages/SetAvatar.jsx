...
import {useNavigate} from 'react-router-dom'; // Link to another page
...
export default function SetAvatar(){
    ...
    <>
    {
        isLoading ? (
            <Container>
                <img src = {loader} alt = "loader" className = "loader" width= "300rem" />
            </Container>
        ):(
        ...
        <div className='title-container'>
            <h1>Pick an avatar that matches you the best</h1>
        </div>
        ...
        <button className = "refresh-btn" onClick = {setRefresh}>
            Check Other
        </button>
